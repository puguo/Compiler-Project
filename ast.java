...
class ProgramNode extends ASTnode {
    ...
    public void codeGen(){
        Sym.setStrings(new HashMap<String,String>());
        myDeclList.codeGen();
    }
...
class FnBodyNode extends ASTnode {
    ...
    public void codeGen(String EndLabel){
        myStmtList.codeGen(EndLabel);
    }
...
class FnDeclNode extends DeclNode {
    ...
    public Sym nameAnalysis(SymTable symTab) {
        ...
        //this counts for all the local variable,since each vardecl 
        //would add to startOffset
        sym.offset = Sym.startOffset; 
        try {
    ...
    public void codeGen(){
        ...
        //push ra and control link
        Codegen.genPush(Codegen.RA);
        Codegen.genPush(Codegen.FP);
        Codegen.generate("subu", Codegen.SP, Codegen.SP, - 8 - myId.sym().offset);
        Codegen.generate("addu", Codegen.FP, Codegen.SP, -myId.sym().offset);

        myBody.codeGen(EndLabel);
        Codegen.genLabel(EndLabel);
        //end process as main is finished
        if(myId.name().equals("main")){
            Codegen.generate("li", Codegen.V0, 10);
            Codegen.generate("syscall");
            return;
        }
        //return and restore, return value in V0
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codeGen(String EndLabel){
        ...
        String name = ((IdNode) myExp).name();
        if(sym.global){
            Codegen.generate("lw", Codegen.V0, "_" + name);
            Codegen.generate("add", Codegen.V0, Codegen.V0, 1);
            Codegen.generate("sw", Codegen.V0, "_" + name);
            return ;
        }
...
class PostDecStmtNode extends StmtNode {
    ...
    public void codeGen(String EndLabel){
        ...
        if(sym.global){
            Codegen.generate("lw", Codegen.V0, "_" + name);
            Codegen.generate("sub", Codegen.V0, Codegen.V0, 1);
            Codegen.generate("sw", Codegen.V0, "_" + name);
            return ;
            }
        Codegen.generateIndexed("lw", Codegen.V0, Codegen.FP, sym.offset);
...
class ReadStmtNode extends StmtNode {
    ...
    public void codeGen(String EndLabel) {
        ...
        Codegen.generate("beq", Codegen.V0, Codegen.V1, doneLabel);
...
class WriteStmtNode extends StmtNode {
    ...
    public void codeGen(String EndLabel) {
        ...
        Codegen.generate("li", Codegen.V0, code);
        Codegen.generate("syscall");
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(String EndLabel){
        //numeric apporach
        myExp.codeGen();
        String LoopEndLabel = Codegen.nextLabel();
        Codegen.genPop(Codegen.V0);
        Codegen.generate("li", Codegen.V1, Codegen.FALSE);
        Codegen.generate("beq", Codegen.V0, Codegen.V1, LoopEndLabel);
        myStmtList.codeGen(EndLabel);
        Codegen.genLabel(LoopEndLabel);;
    }
...
class IfElseStmtNode extends StmtNode {
    ...
    public void codeGen(String EndLabel) {
        ...
        myThenStmtList.codeGen(EndLabel);
        Codegen.generate("j", endLabel);
        Codegen.genLabel(falseLabel);
        myElseStmtList.codeGen(EndLabel);
        Codegen.genLabel(endLabel);
    }
...
class StringLitNode extends ExpNode {
    ...
    public void codeGen(){
        String strLabel = "";
        if(Sym.checkStrings(myStrVal)){
            strLabel = Sym.getString(myStrVal);
        }
        else{
            ...
            Codegen.generate(".text");
            Sym.addString(myStrVal, strLabel);
        }
...
class IdNode extends ExpNode {
    ...
    public void genAddr() {
        //wrote as assignment decribed, but I can't fix the problem with it
        //so it's not used
        if(!mySym.global){
...
class AssignExpNode extends ExpNode {
    ...
    public void codeGen(){
    /*  Appoarch with  genAddr, but failed
        myExp.codeGen();
...
class EqualsNode extends EqualityExpNode {
    ...
    public void codeGen(){
        if (myExp1 instanceof StringLitNode && myExp2 instanceof StringLitNode){
            if(((StringLitNode) myExp1).str().equals(((StringLitNode) myExp2).str())){
                Codegen.generate("li", Codegen.T0, Codegen.TRUE);
            } else {
                Codegen.generate("li", Codegen.T0, Codegen.FALSE);
            }
